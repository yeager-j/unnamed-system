 ...
 * engine's boundary functions take their catalog lookups as explicit
 * {@link import("@workspace/game/engine").ArchetypeLookup ports} and `newId`
 * explicitly — never a hidden global — so {@link createGameEngine} binds them
 * once to the production {@link gameData} adapter (and the default id generator)
 * and this module re-exports the pre-bound versions the app calls.
 *
