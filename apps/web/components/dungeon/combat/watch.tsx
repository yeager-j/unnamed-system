 ...
 * redacted battlefield), swapping only the poll source for the **fogged** delve
 * endpoint so a player never sees combatants in zones the DM hasn't revealed. Keyed by the **encounter** `shortId` — the watch's
