 ...
 * {@link import("@/components/dungeon/canvas/explore/zone-node").DungeonZoneNode} and the player fog view's
 * {@link import("@/components/dungeon/canvas/watch/zone-node").DungeonWatchZoneNode} so the two views of
