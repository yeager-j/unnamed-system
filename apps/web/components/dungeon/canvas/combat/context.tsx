 ...
 * combat {@link import("@/components/dungeon/canvas/combat/zone-node").DungeonCombatZoneNode} and the
 * turn-loop Panels ({@link import("@/components/dungeon/canvas/combat/turn-bar").CombatTurnBar} +
 * {@link import("@/components/dungeon/canvas/combat/spine-panel").CombatSpinePanel}). The combat peer of
 * {@link import("@/components/dungeon/canvas/explore/context").DungeonCanvasContextValue}: while a
