...
/**
 * The five Identity Trait fields, as the v2 `narrative` component names them
 * (a subset of its text fields).
 */
export type IdentityTraitField = Extract<
  NarrativeTextField,
  "personality" | "hopes" | "dreams" | "fears" | "secrets"
>
