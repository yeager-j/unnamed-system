 ...
 * party {@link import("@/app/campaigns/[campaignShortId]/dungeon/[shortId]/_components/canvas/explore/token-chip").DungeonTokenChip} and the
 * fog node chips. The one place the "portrait when one exists, else a
