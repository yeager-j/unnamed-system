 ...
 * silently land on step 1. Only `basic-info` has a real body in
 * this ticket — every other step renders the placeholder pointing at the
 * sibling ticket that owns it.
 *
...
function renderStepBody({
  ...
  switch (step) {
    ...
    case "path-and-archetype":
      return <StepPlaceholder stepLabel={labelFor(step)} ticket="UNN-205" />
    case "background":
      return (
        <StepPlaceholder
