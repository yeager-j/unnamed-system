...
| C12 | PRESERVE | D17/G7 passive effects; C6 | attackRollEffectsFromSkills collects only passive skills' attackRoll effects. Shared char+enemy path — consistent with D8 Mechanics-on-any-entity + I/J unification. |
