...
| C6 | PRESERVE | D8 layer 3/4 (passive skills, D19), D19 | Passive-skill attribute bonuses from active passive skills only. D19: passives are resolved output of archetype∪equip∪inheritance. |
